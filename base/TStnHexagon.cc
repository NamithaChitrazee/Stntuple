...
#include "base/TStnHexagon.hh"

ClassImp(TStnHexagon)
...
//-----------------------------------------------------------------------------
TStnHexagon::TStnHexagon(double Size, double X0, double Y0) {
  fSize = Size;
  fX0   = X0; 
  fY0   = Y0;
}
...
//-----------------------------------------------------------------------------
void TStnHexagon::Paint(Option_t* Opt) {
...
// 
//-----------------------------------------------------------------------------
int TStnHexagon::Test(double HexSize, double RIn, double ROut) {
  //  const int nk = 11;

  //  int ind[nk] = {585,583,703,582,704,705,584,829,830,72,469};

  printf("TStnHexagon::Test needs to be reimplemented. BAIL OUT\n");
