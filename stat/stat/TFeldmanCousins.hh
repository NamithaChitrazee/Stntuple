//
#ifndef __murat_alg_Stntuple_TFeldmanCousins__
#define __murat_alg_Stntuple_TFeldmanCousins__
...
namespace stntuple {
class TFeldmanCousins : public TNamed {
public:
  enum {
...
// functions
//-----------------------------------------------------------------------------
  TFeldmanCousins(const char* Name,
		   double      CL,
		   int         DebugLevel = 0);
