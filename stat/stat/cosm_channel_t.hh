...
//-----------------------------------------------------------------------------
#ifndef __Stntuple_stat_cosm_channel_t_hh__
#define __Stntuple_stat_cosm_channel_t_hh__
...
namespace stntuple {
  class  cosm_channel_t : public channel_t {
  public:
    double     fVal;
...
// functions
//-----------------------------------------------------------------------------
    cosm_channel_t(const char* Name, int Debug = 0);
