...
///////////////////////////////////////////////////////////////////////////////
#include "su2020/stat/model_t.hh"

//-----------------------------------------------------------------------------
void build_model(su2020::model_t* m, const char* Config) {
  ...
  pgau_t* lumi      = new pgaus_t("lumi",lum0,sig_lum);

  fListOfParameters->Add(lumi);

  channel_t* dio     = new dio_channel_t   ();
...
void test_001(int NEvents = 10) {
  ...
  su2020::model_t* m = new su2020::model_t("aaa");
